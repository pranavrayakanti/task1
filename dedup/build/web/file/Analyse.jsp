    ...
    <div id="container">
        ...
        <div>
            <div id="content">
                ...
                PreparedStatement ps=con.prepareStatement("select * from adminupload");
                ...
                <form action="DetectFraud.jsp" method="post">
                    <table>
                        <tr><td>Enter the Company Name:</td><td><select style="width: 300px" name="Company" >
                                    <%
                                        while(rs.next())
                    {
                                    %>
